...
/**
 * Clerk webhook handler for Zenthea
 *
 * Syncs user and organization data from Clerk to our AWS Postgres database.
...
export async function POST(req: Request) {
  ...
  const wh = new Webhook(zentheaEnv.server.CLERK_WEBHOOK_SECRET)
