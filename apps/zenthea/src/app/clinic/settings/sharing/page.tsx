...
/**
 * Redirect page for /clinic/settings/sharing → /company/settings/sharing
 * Part of route restructuring from /clinic/ to /company/
 * See ROUTE_RESTRUCTURING_PLAN.md for details
 */
export default function ClinicSettingsSharingRedirect() {
  ...
  useEffect(() => {
    ...
    const redirectUrl = queryString 
      ? `/company/settings/sharing?${queryString}`
