...
/**
 * Redirect page for /clinic/settings/roles/new → /company/settings/roles/new
 * Part of route restructuring from /clinic/ to /company/
 * See ROUTE_RESTRUCTURING_PLAN.md for details
 */
export default function ClinicSettingsRolesNewRedirect() {
  ...
  useEffect(() => {
    ...
    const redirectUrl = queryString 
      ? `/company/settings/roles/new?${queryString}`
