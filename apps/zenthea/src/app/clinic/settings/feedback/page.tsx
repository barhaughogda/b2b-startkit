...
/**
 * Redirect page for /clinic/settings/feedback → /company/settings/feedback
 * Part of route restructuring from /clinic/ to /company/
 * See ROUTE_RESTRUCTURING_PLAN.md for details
 */
export default function ClinicSettingsFeedbackRedirect() {
  ...
  useEffect(() => {
    ...
    const redirectUrl = queryString 
      ? `/company/settings/feedback?${queryString}`
